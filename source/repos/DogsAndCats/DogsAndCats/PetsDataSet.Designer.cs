...
namespace DogsAndCats {
    ...
    public partial class PetsDataSet : global::System.Data.DataSet {
        ...
        public partial class PetDataTable : global::System.Data.TypedTableBase<PetRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PetRow AddPetRow(int Id, string Name, int TypeId) {
        ...
        public partial class PetTypeDataTable : global::System.Data.TypedTableBase<PetTypeRow> {
            ...
            private global::System.Data.DataColumn columnPetNameType;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn PetNameTypeColumn {
                get {
                    return this.columnPetNameType;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PetTypeRow AddPetTypeRow(string PetNameType) {
            ...
            internal void InitVars() {
                this.columnId = base.Columns["Id"];
                this.columnPetNameType = base.Columns["PetNameType"];
            }
            ...
            private void InitClass() {
                this.columnId = new global::System.Data.DataColumn("Id", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnId);
                this.columnPetNameType = new global::System.Data.DataColumn("PetNameType", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnPetNameType);
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnId}, true));
                ...
                this.columnId.Unique = true;
                this.columnPetNameType.AllowDBNull = false;
                this.columnPetNameType.MaxLength = 50;
            }
        ...
        public partial class PetTypeRow : global::System.Data.DataRow {
            ...
            public string PetNameType {
                get {
                    return ((string)(this[this.tablePetType.PetNameTypeColumn]));
                }
                set {
                    this[this.tablePetType.PetNameTypeColumn] = value;
                }
            }
        }
...
namespace DogsAndCats.PetsDataSetTableAdapters {
    ...
    public partial class PetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DogsAndCats.Properties.Settings.Default.PetsConnectionString;
        }
    ...
    public partial class PetTypeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Id", "Id");
            tableMapping.ColumnMappings.Add("PetNameType", "PetNameType");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PetType] WHERE (([Id] = @Original_Id) AND ([PetNameType] = @Or" +
                "iginal_PetNameType))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_PetNameType", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PetNameType", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PetType] ([PetNameType]) VALUES (@PetNameType);\r\nSELECT Id, Pe" +
                "tNameType FROM PetType WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PetNameType", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PetNameType", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[PetType] SET [PetNameType] = @PetNameType WHERE (([Id] = @Original_" +
                "Id) AND ([PetNameType] = @Original_PetNameType));\r\nSELECT Id, PetNameType FROM P" +
                "etType WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PetNameType", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PetNameType", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_PetNameType", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PetNameType", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, PetNameType FROM dbo.PetType";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_PetNameType) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_PetNameType == null)) {
                throw new global::System.ArgumentNullException("Original_PetNameType");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_PetNameType));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string PetNameType) {
            if ((PetNameType == null)) {
                throw new global::System.ArgumentNullException("PetNameType");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(PetNameType));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PetNameType, int Original_Id, string Original_PetNameType, int Id) {
            if ((PetNameType == null)) {
                throw new global::System.ArgumentNullException("PetNameType");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(PetNameType));
            }
            ...
            if ((Original_PetNameType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_PetNameType));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PetNameType, int Original_Id, string Original_PetNameType) {
            return this.Update(PetNameType, Original_Id, Original_PetNameType, Original_Id);
        }
    }
